 ...
 * credentials are captured when `bua-rpc` is compiled, so a binary built in a checkout
  ...
  return (
    <div className="unconfigured">
      ...
      <p>
        ...
        into <code>bua-rpc</code> when it is compiled, so this is fixed by building it
      ...
      <p className="aside">
        If the agent checkout is not at <code>~/repos/brave-user-agent</code>, set{' '}
        <code>BUA_AGENT_DIR</code> before building.
      </p>
      <details>
